...
<img src="../../assets/004_thread_mgmt-3.png" width="1200" height="800">
...
<img src="../../assets/004_thread_mgmt-4.png" width="1200" height="800">
...
```text
/tmp/mdlab/main.mojo:26:16: warning: deprecated implicit conversion from 'Int' to 'UInt'
        if i < size:         # // 🚫 Threads with idx >= n do nothing and return safely
/tmp/mdlab/main.mojo:26:16: note: call 'UInt(...)' explicitly
        if i < size:         # // 🚫 Threads with idx >= n do nothing and return safely
/tmp/mdlab/main.mojo:1:1: note: '@implicit' constructor 'UInt.__init__' declared here
from memory import UnsafePointer
^
/tmp/mdlab/main.mojo:27:19: error: expression must be mutable in assignment
            output[i] = a[i] + 10.0
            ~~~~~~^~~
/tmp/mdlab/main.mojo:47:48: error: no matching method in call to 'enqueue_function_checked'
    ctx.enqueue_function_checked[add_10,add_10](
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~^
/tmp/mdlab/main.mojo:1:1: note: candidate not viable: callee parameter 'Ts' has 'DevicePassable' type, but value has type 'fn[?, mut`2x: Bool, origin`2x1: Origin[mut], mut`2x2: Bool, origin`2x3: Origin[mut]](output: UnsafePointer[Float32, origin], a: UnsafePointer[Float32, origin], size: Int) -> None'
from memory import UnsafePointer
^
/tmp/mdlab/main.mojo:1:1: note: candidate not viable: failed to infer parameter 'declared_arg_types', it isn't used in any argument
from memory import UnsafePointer
^
/tmp/mdlab/main.mojo:1:1: note: candidate not viable: failed to infer parameter 'declared_arg_types', it isn't used in any argument
from memory import UnsafePointer
^
/tmp/mdlab/main.mojo:70:16: warning: deprecated implicit conversion from 'Int' to 'UInt'
        if i < size:   
               ^~~~
/tmp/mdlab/main.mojo:70:16: note: call 'UInt(...)' explicitly
        if i < size:   
               ^~~~
               UInt( )
/tmp/mdlab/main.mojo:1:1: note: '@implicit' constructor 'UInt.__init__' declared here
from memory import UnsafePointer
^
/tmp/mdlab/main.mojo:71:19: error: expression must be mutable in assignment
            output[i] = a[i] + 10.0  
            ~~~~~~^~~
/tmp/mdlab/main.mojo:92:39: warning: `enqueue_function` is deprecated. Use `enqueue_function_checked` instead.
    ctx_2k.enqueue_function[add_10_2k](
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~^
/tmp/mdlab/main.mojo:1:1: note: 'enqueue_function' declared here
from memory import UnsafePointer
^
/tmp/mdlab/main.mojo:116:18: warning: deprecated implicit conversion from 'Int' to 'UInt'
        if row < size and col < size:
                 ^~~~
/tmp/mdlab/main.mojo:116:18: note: call 'UInt(...)' explicitly
        if row < size and col < size:
                 ^~~~
                 UInt( )
/tmp/mdlab/main.mojo:1:1: note: '@implicit' constructor 'UInt.__init__' declared here
from memory import UnsafePointer
^
/tmp/mdlab/main.mojo:116:33: warning: deprecated implicit conversion from 'Int' to 'UInt'
        if row < size and col < size:
                                ^~~~
/tmp/mdlab/main.mojo:116:33: note: call 'UInt(...)' explicitly
        if row < size and col < size:
                                ^~~~
                                UInt( )
/tmp/mdlab/main.mojo:1:1: note: '@implicit' constructor 'UInt.__init__' declared here
from memory import UnsafePointer
^
/tmp/mdlab/main.mojo:117:26: warning: deprecated implicit conversion from 'Int' to 'UInt'
            output[row * size + col] = a[row * size + col] + 10.0
                         ^~~~
/tmp/mdlab/main.mojo:117:26: note: call 'UInt(...)' explicitly
            output[row * size + col] = a[row * size + col] + 10.0
                         ^~~~
                         UInt( )
/tmp/mdlab/main.mojo:1:1: note: '@implicit' constructor 'UInt.__init__' declared here
from memory import UnsafePointer
^
/tmp/mdlab/main.mojo:117:19: error: expression must be mutable in assignment
            output[row * size + col] = a[row * size + col] + 10.0
            ~~~~~~^~~~~~~~~~~~~~~~~~
